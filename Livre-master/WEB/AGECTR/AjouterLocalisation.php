...
<head>
  ...
  <script src="js/pullLocalisation.js" charset="utf-8"></script>
  <script src="js/changerLocalisation.js" charset="utf-8"></script>
...
<body class="hold-transition sidebar-mini">
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <div class="container-fluid col-md-12">
          <h1 style="text-align:center !important;float:none;font-weight:bold;" class="card-title">Ajout localisation</h1>
          <br>
          <br>
        </div>
      </section>
    ...
    <div class="col-sm-12">
      <table id="tblLocalisation" class="display table table-striped table-bordered" style="width:100%">
        <thead>
          <tr>
            <th>ID</th>
            <th>Titre</th>
    ...
    <div id="AjoutLocalisationModal" class="modal fade" role="dialog">
      <div class="modal-dialog text-center">
        <div class="modal-content text-center">
          <div style="margin:0px auto;border:none;" class="modal-header text-center">
            <h4 class="modal-title">Ajouter une localisation à la concession</h4>
          </div>
          <div style="border:none" class="modal-body text-center">
            <label for="localisation">Entrez la localisation de la concession</label>
            <br>
            <input  type="text" name="localisation" id="localisation" value="" placeholder="Localisation">


          </div>
          <div style="border:none" class="modal-footer">
            <input id="idLocalisation" type="hidden"/>
            <button type="button"  class="btn btn-secondary float-right" data-dismiss="modal">Annuler</button>
            <input type="button" name="ajoutLocalisation" class="btn btn-success" id="ajoutLocalisation" value="Ajouter" class="float-right" />
          </div>
        </div>
      </div>
    </div>
