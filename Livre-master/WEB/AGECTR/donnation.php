...
<head>
  ...
  <script src="js/accepterDonation.js"></script>
...
<body class="hold-transition sidebar-mini">
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <div class="container-fluid col-md-12">
          <h1 style="text-align:center !important;float:none;font-weight:bold;" class="card-title">Liste des donations</h1>
          <br>
          <br>
        </div>
      </section>
    ...
    <div class="col-sm-12">
      <table id="tblDonations" class="display table table-striped table-bordered" style="width:100%">
        <thead>
          <tr>
            <th>ID</th>
            <th>Titre</th>
      ...
      <div class="modal-dialog text-center">
        <div class="modal-content text-center">
          <div style="margin:0px auto;border:none;" class="modal-header text-center">
            <h4 id="titre" class="modal-title">Accepter la donation</h4>
          </div>
          <div style="border:none" class="modal-body text-center">
            <label id="message">Êtes-vous certain de vouloir accepter la donation ?</label>

          </div>
          <div style="border:none" class="modal-footer">
            <input id="id" type="hidden"/>
            <button type="button"  class="btn btn-secondary float-right" data-dismiss="modal">Annuler</button>
            <input type="button" name="donation" class="btn btn-success" id="donation" value="Accepter" class="float-right" />
          </div>
        </div>
      </div>
    </div>
