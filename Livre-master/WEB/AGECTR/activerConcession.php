...
<head>
  ...
  <script src="js/pullConcession.js" charset="utf-8"></script>
  <script src="js/accepterConcession.js" charset="utf-8"></script>
  <script src="js/refuserConcession.js" charset="utf-8"></script>
...
<body class="hold-transition sidebar-mini">
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <div class="container-fluid col-md-12">
          <h1 style="text-align:center !important;float:none;font-weight:bold;" class="card-title">Validation des concessions</h1>
          <br>
          <br>
        </div>
      </section>
    ...
    <div class="col-sm-12">
      <table id="tblValidationConcession" class="display table table-striped table-bordered" style="width:100%">
        <thead>
          <tr>
            <th>ID</th>
            <th>Titre</th>
      ...
      <div class="modal-dialog text-center">
        <div class="modal-content text-center">
          <div style="margin:0px auto;border:none;" class="modal-header text-center">
            <h4 class="modal-title">Accepter la concession</h4>
          </div>
          <div style="border:none" class="modal-body text-center">
            <label>Êtes-vous certain de vouloir accepter la nouvelle concession ?</label>
    ...
    <div id="supprimerModal" class="modal fade" role="dialog">
      <div class="modal-dialog text-center">
        <div class="modal-content text-center">
          <div style="margin:0px auto;border:none;" class="modal-header text-center">
            <h4 class="modal-title">Refuser la concession</h4>
          </div>
          <div style="border:none" class="modal-body text-center">
            <label>Êtes-vous certain de vouloir refuser la concession ?</label>
