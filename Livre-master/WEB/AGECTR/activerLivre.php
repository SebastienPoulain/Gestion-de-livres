...
<head>
  ...
  <script src="js/pullLivre.js" charset="utf-8"></script>
  <script src="js/accepterLivre.js" charset="utf-8"></script>
  <script src="js/refuserLivre.js" charset="utf-8"></script>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <div class="container-fluid col-md-12">
          <h1 style="text-align:center !important;float:none;font-weight:bold;" class="card-title">Validation de livres</h1>
          <br>
          <br>
        </div>
      </section>
      ...
      <div class="modal-dialog text-center">
        <div class="modal-content text-center">
          <div style="margin:0px auto;border:none;" class="modal-header text-center">
            <h4 class="modal-title">Accepter le livre</h4>
          </div>
    ...
    <div id="supprimerModal" class="modal fade" role="dialog">
      <div class="modal-dialog text-center">
        <div class="modal-content text-center">
          <div style="margin:0px auto;border:none;" class="modal-header text-center">
            <h4 class="modal-title">Refuser le livre</h4>
          </div>
          <div style="border:none" class="modal-body text-center">
