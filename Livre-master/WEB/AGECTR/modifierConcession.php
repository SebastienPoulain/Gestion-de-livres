...
<head>
  ...
  <script src="js/pullModifConcession.js" charset="utf-8"></script>
  <script src="js/accepterPrix.js" charset="utf-8"></script>
  <script src="js/refuserPrix.js" charset="utf-8"></script>
...
<body class="hold-transition sidebar-mini">
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <div class="container-fluid col-md-12">
          <h1 style="text-align:center !important;float:none;font-weight:bold;" class="card-title">Modification des concessions</h1>
          <br>
          <br>
        </div>
      </section>
    ...
    <div class="col-sm-12">
      <table id="tblModifConcession" class="display table table-striped table-bordered" style="width:100%">
        <thead>
          <tr>
            <th>ID</th>
            <th>Titre</th>
            ...
            <th>Prix après la modification</th>
            <th>Actions</th>
          </tr>
        </thead>
      </table>
      ...
      <div class="modal-dialog text-center">
        <div class="modal-content text-center">
          <div style="margin:0px auto;border:none;" class="modal-header text-center">
            <h4 class="modal-title">Accepter le changement de prix</h4>
          </div>
          <div style="border:none" class="modal-body text-center">
            <label>Êtes-vous certain de vouloir accepter le changement de prix ?</label>

          </div>
          <div style="border:none" class="modal-footer">
            <input id="idAccepter" type="hidden"/>
            <input id="prix" type="hidden"/>
            <input id="ancienPrix" type="hidden"/>
    ...
    <div id="supprimerModal" class="modal fade" role="dialog">
      <div class="modal-dialog text-center">
        <div class="modal-content text-center">
          <div style="margin:0px auto;border:none;" class="modal-header text-center">
            <h4 class="modal-title">Refuser le changement de prix</h4>
          </div>
          <div style="border:none" class="modal-body text-center">
            <label>Êtes-vous certain de vouloir refuser le changement de prix ?</label>
