...
$sql = "SELECT c.id,b.title,b.author,b.publisher,b.edition,b.barcode,c.createdDate,c.customerPrice,c.localisation";
$sql.=" FROM book b inner join concession c on b.id = c.idBook";
$sql.=" Where c.valide = 1";
...
if (!empty($requestData['search']['value'])) {   //name
    ...
    $sql.=" OR localisation LIKE '".$requestData['search']['value']."%' ";
