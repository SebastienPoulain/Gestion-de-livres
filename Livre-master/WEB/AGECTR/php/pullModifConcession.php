...
$sql = "SELECT c.id,b.title,b.author,b.publisher,b.edition,b.barcode,c.createdDate,c.customerPrice,c.modif_prix";
$sql.=" FROM book b inner join concession c on b.id = c.idBook";
$sql.=" WHERE c.valide = 5";
...
if (!empty($requestData['search']['value'])) {   //name
    ...
    $sql.=" OR modif_prix LIKE '".$requestData['search']['value']."%' ";
