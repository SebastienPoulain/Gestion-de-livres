...
<head>
  ...
  <script src="js/pullImg.js" charset="utf-8"></script>
  <script src="js/setImg.js" charset="utf-8"></script>
...
<body class="hold-transition sidebar-mini">
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <div class="container-fluid col-md-12">
          <h1 style="text-align:center !important;float:none;font-weight:bold;" class="card-title">Images des livres</h1>
          <br>
          <br>
        </div>
      </section>
    ...
    <div class="col-sm-12">
      <table id="tblLivre" class="display table table-striped table-bordered" style="width:100%">
        <thead>
          <tr>
            <th>Titre</th>
            <th>Auteur</th>
      ...
      <div class="modal-dialog text-center">
        <div class="modal-content text-center">
          <div style="margin:0px auto;border:none;" class="modal-header text-center">
            <h4 class="modal-title">Changer l'image du livre</h4>
          </div>
          <div style="border:none" class="modal-body text-center">
            <form id="ajoutImg" method="post" enctype="multipart/form-data" >


            <p><label>Sélectionnez une image</label>
            <input type="file" name="image" id="image"/></p>

          </div>
          <div style="border:none" class="modal-footer">
            <input id="idImg" name="idImg" type="hidden"/>
            <button type="button" id="fermer" class="btn btn-secondary float-right" data-dismiss="modal">Annuler</button>
            <input type="submit" name="img" class="btn btn-success" id="img" value="Changer" class="float-right" />
            </form>
          </div>
        </div>
      </div>
