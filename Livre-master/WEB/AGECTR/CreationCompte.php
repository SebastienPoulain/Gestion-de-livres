...
<head>
  ...
  <script src="js/pullCreationCompte.js" charset="utf-8"></script>
  <script src="js/setEmail.js" charset="utf-8"></script>
  <script src="js/setPassword.js" charset="utf-8"></script>
...
<body class="hold-transition sidebar-mini">
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <div class="container-fluid col-md-12">
          <h1 style="text-align:center !important;float:none;font-weight:bold;" class="card-title">Création de comptes</h1>
          <br>
          <br>
        </div>
      </section>
    ...
    <div class="col-sm-12">
      <table id="tblCreationCompte" class="display table table-striped table-bordered" style="width:100%">
        <thead>
          <tr>
            <th>Matricule</th>
            <th>Nom</th>
      ...
      <div class="modal-dialog text-center">
        <div class="modal-content text-center">
          <div style="margin:0px auto;border:none;" class="modal-header text-center">
            <h4 class="modal-title">Associer une adresse courriel</h4>
          </div>
          <div style="border:none" class="modal-body text-center">
            <label for="addrEmail">Entrez l'adresse courriel à associer à </label><span style="font-weight:bold;text-align:center;" id="userName"></span>
            <input style="display:inline-block" type="text" name="addrEmail" id="addrEmail" value="" placeholder="Adresse courriel">

          </div>
          <div style="border:none" class="modal-footer">
            <input id="idEmail" type="hidden"/>
            <button type="button" id="fermer" class="btn btn-secondary float-right" data-dismiss="modal">Annuler</button>
            <input type="button" name="email" class="btn btn-success" id="email" value="Associer" class="float-right" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="passwordModal" class="modal fade" role="dialog">
      <div class="modal-dialog text-center">
        <div class="modal-content text-center">
          <div style="margin:0px auto;border:none;" class="modal-header text-center">
            <h4 class="modal-title">Générer un mot de passe</h4>
          </div>
          <div style="border:none" class="modal-body text-center">
          <label style="font-size:14px;">Êtes-vous certain de vouloir générer un nouveau mot de passe pour </label> <span style="font-weight:bold;text-align:center;display:inline-block;" id="userName2"></span>
          <span style="display:block;">Voici le mot de passe temporaire</span><input style="display:block;margin:0 auto;"type="text" name="valeurMotdePasse" id="valeurMotdePasse" value="" readonly>
          </div>
          <div style="border:none" class="modal-footer">
            <input id="idPassword" type="hidden"/>
            <button type="button"  class="btn btn-secondary float-right" data-dismiss="modal">Annuler</button>
            <input type="button" name="password" class="btn btn-success" id="password" value="Générer" class="float-right" />
          </div>
        </div>
      </div>
    </div>
